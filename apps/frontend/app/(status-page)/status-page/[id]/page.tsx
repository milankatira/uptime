...
import { Maximize, BellOff, Minimize } from "lucide-react";
...
function StatusPage() {
    ...
    return (
        <div ref={containerRef} className="min-h-screen bg-dark w-full bg-gray-100 dark:bg-gray-900">
            <div className="max-w-5xl mx-auto py-8 px-4 sm:px-6">
                ...
                {/* System Status Card */}
                <Card className="mb-8 rounded-lg shadow-lg p-6 bg-white text-black">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                            ...
                            {latency !== null && (
                                <span className="ml-2 text-sm text-gray-800">Latency: <span className="font-semibold text-white bg-gray-700 rounded px-2 py-0.5">{latency} ms</span></span>
                            )}
                        </div>
                    </div>
                </Card>
                        ...
                        <div className="mb-4">
                            <div className="flex justify-between items-center mb-2">
                                <div className="flex items-center">
                                    ...
                                    <span className="text-sm text-gray-800">→ {uptime.toFixed(2)}%</span>
                                </div>
                            ...
                            {latency !== null && (
                                <div className="mt-2 text-sm text-gray-800">Latest latency: <span className="font-semibold text-white bg-gray-700 rounded px-2 py-0.5">{latency} ms</span></div>
                            )}
                        </div>
                    ) : (
                ...
                {/* Footer */}
                <div className="mt-12 flex justify-between items-center text-sm text-gray-200">
                    <div className="flex items-center gap-6">
                        <button onClick={toggleFullscreen} className="flex items-center gap-2 hover:text-white transition-colors">
                            {isFullscreen ? (
                                <>
                                    <Minimize size={16} />
