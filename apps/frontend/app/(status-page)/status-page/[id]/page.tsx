...
function StatusPage() {
  ...
  return (
    <div
      ref={containerRef}
      className="bg-dark min-h-screen w-full bg-gray-100 dark:bg-gray-900"
    >
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className="text-right">
            <h2 className="mb-1 text-2xl font-medium">Service status</h2>
        ...
        <Card className="mb-8 rounded-lg bg-white p-6 text-black shadow-lg">
          <div className="flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-full">
              <div className={`h-8 w-8 rounded-full ${statusColor}`}></div>
            </div>
            <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-2">
              <span className="mr-2 text-2xl font-medium">All systems</span>
              <span
            ...
            <div className="mb-4">
              <div className="mb-2 flex items-center justify-between">
                <div className="flex items-center">
                  <span className="mr-2 font-medium">{website.url}</span>
                  <span className="text-sm text-gray-800">
                    → {uptime.toFixed(2)}%
                  </span>
                </div>
                <Badge className={`${badgeColor} border-0 text-white`}>
                  {displayStatus}
                </Badge>
              </div>
              <div className="h-8">
        ...
        <div className="mt-12 flex items-center justify-between text-sm text-gray-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-white">UptimeRobot</span>
          </div>
        </div>
      </div>
    </div>
