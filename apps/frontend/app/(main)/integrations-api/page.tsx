...
import { addEmailConnection, findConnectionByUserId, removeEmailConnection } from '@/action/connection.action';
...
export default function ConnectionsPage() {
  ...
  return (
    <div className='w-full mx-auto py-10 px-4 bg-white dakr:bg-gray-800'>
      {/* Header Section */}
