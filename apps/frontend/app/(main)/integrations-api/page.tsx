...
function IntegrationsSection() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-100 p-6 md:p-10 dark:bg-gray-900">
      <h2 className="mb-8 text-2xl font-semibold text-white">Integrations.</h2>

      <div className="mb-8 flex flex-col gap-8 md:flex-row">
        <div className="w-full space-y-4 md:w-48 lg:w-64">
          <div className="rounded-md bg-indigo-900/20 p-2 text-white">All</div>
          <div className="rounded-md p-2 text-gray-400 hover:bg-gray-800/50">
            Chat platforms
          </div>
          <div className="rounded-md p-2 text-gray-400 hover:bg-gray-800/50">
            Webhooks
          ...
          <div className="rounded-md p-2 text-gray-400 hover:bg-gray-800/50">
            Connectors & Incident management
          </div>
          <div className="rounded-md p-2 text-gray-400 hover:bg-gray-800/50">
            Push notifications
          </div>
        ...
        <div className="flex-1">
          <div className="relative mb-6">
            ...
            <Input
              ...
              className="border-gray-700 bg-gray-900 pl-10 text-gray-300 focus:border-indigo-500"
            />
          </div>
          ...
          <div className="space-y-4">
            {integrations.map((integration) => (
              <div
                key={integration.id}
                className="rounded-lg border border-gray-800 bg-gray-900/80 p-5"
              >
