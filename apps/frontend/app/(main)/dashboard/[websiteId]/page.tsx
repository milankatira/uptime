...
export default function WebsiteDetailsPage() {
    ...
    try {
      ...
      async function refetchWebsiteDetails() {
        ...
        try {
          ...
          console.error(
            "Failed to re-fetch website details after update:",
            err,
          );
        }
      }
  ...
  if (error) {
    return (
      <div className="container mx-auto py-8 text-rose-500">Error: {error}</div>
    );
  }
      ...
      <div className="container mx-auto py-8  h-full">
        ...
        <Card className="mb-6 bg-white dark:bg-gray-900">
          <CardHeader>
            ...
            <CardDescription>
              Visual representation of recent checks.
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                value={editInterval}
                onChange={(e) =>
                  setEditInterval(parseInt(e.target.value, 10) || 0)
                }
                className="col-span-3"
              />
            </div>
