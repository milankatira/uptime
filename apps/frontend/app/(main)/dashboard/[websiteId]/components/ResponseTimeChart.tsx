...
/**
 * Renders an area chart displaying website latency trends over time using aggregated average data.
 * Adapts display based on selected time range (30 minutes, 1 week, 1 month, 1 year).
 */
