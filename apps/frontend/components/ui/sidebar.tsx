...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "hidden h-full w-[300px] shrink-0 bg-gray-100 px-4 py-4 md:flex md:flex-col dark:bg-gray-900",
          className,
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex h-10 w-full flex-row items-center justify-between bg-gray-100 px-4 py-4 md:hidden dark:bg-gray-900",
        )}
        {...props}
      >
