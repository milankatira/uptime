...
const TestimonialsSection = () => {
  return (
    <section id="testimonials" className="py-24 relative">
      <div className="absolute top-1/4 left-0 -z-10 w-[300px] h-[300px] bg-blue-500/5 rounded-full blur-[100px]" />
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            See what our customers have to say about their experience with Uptime.com
          </motion.p>
        </div>
